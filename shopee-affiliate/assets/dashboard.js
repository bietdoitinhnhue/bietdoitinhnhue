(() => {
  ...
  function bind() {
    ...
    $("seedDatabase").onclick=async()=>{try{const result=await api("/api/seed",{method:"POST",body:"{}"});await loadManager();toast(`Đã khởi tạo ${result.seeded} sản phẩm`)}catch(e){toast(e.message)}};
